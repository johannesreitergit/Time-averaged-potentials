...
print('two atoms ',num_points_in_limits(atomnumber, lower,upper))
#plot
# plotter(runs, atomnumber, xlim=xlimit, xlabel='Run number', ylabel='\# atoms')
scatter_hist(runs, atomnumber, xlim=xlimit,ylim=ylimit, xlabel='run number', ylabel='normalised intensity sum',histlabel='counts', fontsize=25, save=True)
